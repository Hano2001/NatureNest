...
export default function AddLocationForm({
  ...
  return (
    <div className="w-full md:w-2/5  h-full md:h-[750px] absolute md:top-12 md:right-12 z-[1500] bg-white rounded-md p-4">
      <button
      ...
      >
        ...
        <div className="flex justify-center items-center md:justify-end w-full p-4">
          <button
            className="p-3 text-white bg-green-500 hover:bg-green-400"
            type="submit"
          >
            Add Location
          </button>
